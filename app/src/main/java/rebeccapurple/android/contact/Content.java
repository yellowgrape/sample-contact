...
public class Content {
    ...
    public static class Photo {
        @SerializedName("id") @Expose private Long __id;                        /** {@link DB.COLUMN#PHOTO_ID} */
        @SerializedName("file") @Expose private Long __file;                    /** {@link DB.COLUMN#PHOTO_FILE_ID} */
        @SerializedName("uri") @Expose private String __uri;                    /** {@link DB.COLUMN#PHOTO_URI} */
        @SerializedName("thumbnail") @Expose private String __thumbnail;        /** {@link DB.COLUMN#PHOTO_THUMBNAIL_URI} */
    ...
    @SerializedName("id") @Expose private Long __id;                        /** {@link DB.COLUMN#ID} */
    @SerializedName("display") @Expose private String __name;               /** {@link DB.COLUMN#DISPLAY_NAME} */
    @SerializedName("lookup") @Expose private String __lookup;              /** {@link DB.COLUMN#LOOKUP} */
    @SerializedName("photo") @Expose public Photo photo;
    @SerializedName("raw") @Expose public Raw raw;
